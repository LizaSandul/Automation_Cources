...
public class Task_5 {
    ...
    private static String highlightLetters(String name, ArrayList<Character> allLetters) {
    ...
    private static boolean nameGuessed(String name, ArrayList<Character> allLetters) {
