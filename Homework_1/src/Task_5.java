...
public class Task_5 {
    ...
    private static void insertLetter(String letter, ArrayList<String> allLetters, int number) {
        allLetters.add(letter);
        number++;
    }

    private static boolean checkLetter(String letter, ArrayList<String> allLetters) {
    ...
    private static String highlightLetters(String name, ArrayList<String> allLetters) {
    ...
    private static boolean nameGuessed(String name, ArrayList<String> allLetters) {
